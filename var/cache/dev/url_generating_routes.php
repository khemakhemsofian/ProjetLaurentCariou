...
return [
    ...
    'design_single' => [['id'], ['_controller' => 'App\\Controller\\DesignController::single'], ['id' => '\\d+'], [['variable', '/', '\\d+', 'id', true], ['text', '/design/single']], [], [], []],
    'app_fond_ecran' => [[], ['_controller' => 'App\\Controller\\FondEcranController::index'], [], [['text', '/fond/ecran']], [], [], []],
    ...
    'graphism_single' => [['id'], ['_controller' => 'App\\Controller\\GraphismController::single'], ['id' => '\\d+'], [['variable', '/', '\\d+', 'id', true], ['text', '/graphism/single']], [], [], []],
