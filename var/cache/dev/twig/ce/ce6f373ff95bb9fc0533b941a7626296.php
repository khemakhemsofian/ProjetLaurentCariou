...
class __TwigTemplate_c5fe623fc54661b26dfdcc1ac1b464d9 extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    <a href=\"mailto:{{ field.value }}\">{{ field.formattedValue }}</a>
{% endif %}
", "@EasyAdmin/crud/field/email.html.twig", "C:\\wamp64\\www\\ProjetFormation\\project\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\crud\\field\\email.html.twig");
    }
}
