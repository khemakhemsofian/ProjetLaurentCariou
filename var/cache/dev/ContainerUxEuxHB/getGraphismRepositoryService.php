 ...
 */
class getGraphismRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GraphismRepository' shared autowired service.
     *
     * @return \App\Repository\GraphismRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GraphismRepository.php';

        return $container->privates['App\\Repository\\GraphismRepository'] = new \App\Repository\GraphismRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
